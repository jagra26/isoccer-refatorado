...
public class Sistema {
    ...
    private void addTecnico(){
        this.tecnico = new Pessoa("Técnico");
    }
    private void addJogador(){
        Jogador contratacao = new Jogador();
    ...
    private void addFuncionario(){
        try {
            ...
            switch (tipo) {
                case 1:
                    funcionario = new Pessoa("Advogado");
                    this.funcionarios.add(funcionario);
                    break;
                case 2:
                    funcionario = new Pessoa("Cozinheiro");
                    this.funcionarios.add(funcionario);
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    funcionario = new Pessoa("Preparador");
                    this.funcionarios.add(funcionario);
                    break;
            }
        }catch (InputMismatchException e){
